 ...
 *
 * $Id: pspiofilemgr_kernel.h 1095 2005-09-27 21:02:16Z jim $
 */
...
typedef struct PspIoDrvFuncs
{
	...
	SceOff (*IoLseek)(PspIoDrvFileArg *arg, u32 unk, SceOff ofs, int whence); 
...
//	int (*IoMount)(PspIoDrvFileArg *arg); 
	int (*IoMount)(PspIoDrvFileArg *arg,const char *ass_name,const char *dev_name,int mode,int unk);
