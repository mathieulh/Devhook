...
#
# $Id: build.mak 1572 2005-12-11 09:57:26Z tyranid $
...
LDFLAGS  := $(addprefix -L,$(LIBDIR)) -specs=$(PSPSDK)/lib/prxspecs -Wl,-q,-Tc:/devkitPSP7/psp/sdk/lib/linkfile.prx $(LDFLAGS)
