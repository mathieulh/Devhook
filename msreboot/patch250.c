...
void reboot250_patch(void)
{
	...
	cache_clr1 = (void *)0x88C03B00;
	cache_clr2 = (void *)0x88C03624;
#if 1
/*
plain TXTの許可
*/
		lp = (unsigned int *)0x88C04ABC;
...
/*
  putc handler regist
*/
	*(unsigned int *)0x88c174d4 = entry_addr; // default putc handler
